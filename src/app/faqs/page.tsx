...
const faqs = [
  ...
  },
  {
    ...
    questions: [
      ...
      { q: "What if the product I received is defective?", a: "Contact us within 7 days via WhatsApp (0300-1234567) and we'll arrange a free pickup and replacement or full refund." },
